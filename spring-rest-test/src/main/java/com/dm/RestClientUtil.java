...
import com.dm.client.HttpRestClient;
import com.dm.client.Netty4RestClient;
import com.dm.client.OkHttpRestClient;
import com.dm.client.SimpleRestClient;
import com.dm.exception.RestClientException;
...
public class RestClientUtil {
    ...
    public static String DEFALUT = "default";
    public static String HTTP_CLIENT = "http-client";
    public static String OKHTTP_CLIENT = "okhttp-client";
    public static String NETTY4_CLIENT = "netty4-client";
    public static String JERSEY = "jersey";
    public static String clientFlag = DEFALUT;

    public synchronized static void setClientFlag(String flag){
        clientFlag = flag;
    }
    ...
    public static RestTemplate getClient() {
        if(clientFlag.equals(DEFALUT))
            return SimpleRestClient.getClient();
        else if(clientFlag.equals(HTTP_CLIENT))
            return HttpRestClient.getClient();
        else if(clientFlag.equals(OKHTTP_CLIENT))
            return OkHttpRestClient.getClient();
        else if(clientFlag.equals(NETTY4_CLIENT))
            return Netty4RestClient.getClient();
        else
            return null;
    }
